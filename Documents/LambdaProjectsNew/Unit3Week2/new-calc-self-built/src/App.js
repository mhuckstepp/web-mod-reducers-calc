  ...
  return (
    <div className="App">
      <nav className="navbar navbar-dark bg-dark">
        <img width="40px" src="./Lambda-Logo-Red.png" alt="pic" /> Lambda
        Reducer Challenge
      </nav>
      ...
      <div className="container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={() => dispatch(setMem())} />
              <CalcButton value={"MR"} onClick={() => dispatch(memTotal())} />
            ...
            <div className="row ce_button">
              <CalcButton value={"CE"} onClick={() => dispatch(clearNum())} />
            </div>
          </form>
        </div>
      </div>
